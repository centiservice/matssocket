    ...
    /*
        ...
        group('connect twice to same MatsSocketSessionId', () {
            ...
            Future<void> connectTwice(Uri url1, Uri url2) async {
                ...
                var receivedEvent = await matsSocket_A.send('Test.ignoreInIncomingHandler', 'SEND_twiceConnect_ensureAssignedSessionId_${matsSocket.randomId(6)}', {});
                ...
                await Future.delayed(Duration(milliseconds: 50), () async {
                  ...
                  var reply = await matsSocket_B.request(
                      'Test.simpleMats', 'REQUEST_twiceConnect_requestOnNewMatsSocket${matsSocket.randomId(6)}', req,
